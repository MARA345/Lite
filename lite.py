...
╠═╣│ │ │ │ ││││├┴┐├┤ 
╩ ╩└─┘ ┴ └─┘┴ ┴└─┘└  
\033[1;92m[+] \033[1;93mCoded  : 4njas
\033[1;92m[+] \033[1;93mThnks  : BL4CK DR4G0N
\033[1;92m[+] \033[1;93mGithub : https://github.com/MARA345

""")
    try:
        asw = input(f"{ch(wrn)}\033[1;37m[ \033[32m1 ].\033[1;37mfrom friend \n[ \033[32m2 ].\033[1;37mfrom group\n[ \033[32m3 ].\033[1;37mlogout\n[ \033[32m4 ].\033[1;37mDelete user\n[ \033[32m5 ].\033[1;37mContact author\n[ \033[32m0 ].\033[1;37mExit\n\n[chouse]_>{ch(wrn)} ")
    except:
        nanya()
...
def grp():
    ...
    print('\033[32m[+]\033[32mMengambil id: Done!           ')
    time.sleep(3)
    print(ch(wrn) + '\033[32m[+]\033[32mTotal id :', len(idg))
    print('\033[32m[+]\033[32mWaiting..')
    print("\033[1;97m════════════════════════════════════════")
    hh = ThreadPool(30)
    hh.map(crack, idg)
